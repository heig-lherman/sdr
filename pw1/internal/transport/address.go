...
// Represents an address on the IP network
type Address struct {
	IP   string
	Port uint16
}
...
// Constructs a new address from a string in the format "IP:Port".
...
// Reports whether the address is strictly less than the given address.
